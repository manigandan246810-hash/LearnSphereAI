...
export function Sidebar({ activeRole, activeTab, setActiveTab }) {
  ...
  const staffNavItems = [
    ...
    { id: 'course-management', label: 'Course Management', icon: FolderKanban, badge: '4 Active' },
    { id: 'weekly-planner', label: 'Weekly Syllabus Planner', icon: Clock, badge: null },
    { id: 'assignment-builder', label: 'Assignment Builder', icon: PlusCircle, badge: null },
    { id: 'quiz-builder', label: 'Quiz & Exam Builder', icon: HelpCircle, badge: null },
  ...
  const navItems = activeRole === 'Student' ? studentNavItems : staffNavItems;
    ...
    <aside style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
        <div style={{
          ...
          {activeRole === 'Student' ? 'Student Workspace' : 'Faculty Management'}
        </div>
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: isActive 
                  ? (activeRole === 'Student' ? '#e0e7ff' : '#f3e8ff')
                  : 'transparent',
                color: isActive 
                  ? (activeRole === 'Student' ? '#3730a3' : '#6b21a8')
                  : '#475569',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <Icon style={{ 
                  ...
                  height: '18px', 
                  color: isActive 
                    ? (activeRole === 'Student' ? '#4f46e5' : '#7c3aed')
                    : '#64748b'
                }} />
